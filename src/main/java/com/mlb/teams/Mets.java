...
@Component
public class Mets implements Team {

	private final String stadium = StadiumNames.Citi_Field;	
	private final Integer timeZone;
	
	private final double latitude = 40.756337; 
	private final double longitude = -73.846043;	

	@Autowired
	public Mets(StadiumTimeZones stadiumTimeZones) {
