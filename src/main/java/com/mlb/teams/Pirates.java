...
@Component
public class Pirates implements Team {

	private final String stadium = StadiumNames.PNC_Park;
	private final Integer timeZone;
	
	private final double latitude = 40.447307; 
	private final double longitude = -80.006841;	

	@Autowired
	public Pirates(StadiumTimeZones stadiumTimeZones) {
