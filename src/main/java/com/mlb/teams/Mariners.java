...
@Component
public class Mariners implements Team {

	private final String stadium = StadiumNames.Safeco_Field;	
	private final Integer timeZone;
	
	private final double latitude = 47.591358; 
	private final double longitude = -122.332283;	

	@Autowired
	public Mariners(StadiumTimeZones stadiumTimeZones) {
