...
@Component
public class Giants implements Team {

	private final String stadium = StadiumNames.AT_T_Park;
	private final Integer timeZone;
	
	private final double latitude = 37.778473; 
	private final double longitude = -122.389595;	

	@Autowired
	public Giants(StadiumTimeZones stadiumTimeZones) {
