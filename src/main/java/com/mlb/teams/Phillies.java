...
@Component
public class Phillies implements Team {

	private final String stadium = StadiumNames.Citizens_Bank_Park;	
	private final Integer timeZone;
	
	private final double latitude = 39.905547; 
	private final double longitude = -75.166589;	

	@Autowired
	public Phillies(StadiumTimeZones stadiumTimeZones) {
