...
@Component
public class Orioles implements Team {

	private final String stadium = StadiumNames.Oriole_Park;	
	private final Integer timeZone;
	
	private final double latitude = 39.283964; 
	private final double longitude = -76.621618;	

	@Autowired
	public Orioles(StadiumTimeZones stadiumTimeZones) {
