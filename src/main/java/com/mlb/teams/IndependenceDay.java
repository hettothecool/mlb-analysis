...
@Component
public class IndependenceDay implements Team {

	private final String stadium = StadiumNames.Fort_Bragg_Field;
	private final Integer timeZone;
	
	private final double latitude = 35.163361; 
	private final double longitude = -79.001028;
	
	@Autowired
	public IndependenceDay(StadiumTimeZones stadiumTimeZones) {
