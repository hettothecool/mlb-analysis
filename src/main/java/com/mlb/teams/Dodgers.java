...
@Component
public class Dodgers implements Team {

	private final String stadium = StadiumNames.Dodger_Stadium;	
	private final Integer timeZone;
	
	private final double latitude = 34.072724; 
	private final double longitude = -118.240646;	

	@Autowired
	public Dodgers(StadiumTimeZones stadiumTimeZones) {
