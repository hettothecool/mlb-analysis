...
@Component
public class Rays implements Team {

	private final String stadium = StadiumNames.Tropicana_Field;	
	private final Integer timeZone;
	
	private final double latitude = 27.76816; 
	private final double longitude = -82.653465;	

	@Autowired
	public Rays(StadiumTimeZones stadiumTimeZones) {
