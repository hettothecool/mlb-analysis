...
@Component
public class Athletics implements Team {

	private final String stadium = StadiumNames.Oakland_Coliseum;	
	private final Integer timeZone;
	
	private final double latitude = 37.751605; 
	private final double longitude = -122.200523;	

	@Autowired
	public Athletics(StadiumTimeZones stadiumTimeZones) {
