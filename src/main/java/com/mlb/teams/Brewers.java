...
@Component
public class Brewers implements Team {

	private final String stadium = StadiumNames.Miller_Park;
	private final Integer timeZone;
	
	private final double latitude = 43.027982; 
	private final double longitude = -87.971165;	

	@Autowired
	public Brewers(StadiumTimeZones stadiumTimeZones) {
